...
<ul>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> 경기 이벤트 수정 오류 있음. 어시만 수정됨. 골이 수정이 안됨.</li>
...
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> 자살골 표시 및 입력</li>
