...
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> <s>홈 화면 그래프 모바일 화면에서도 무리없이 보이도록, 위젯 형태로 변환 해주기></s></li>
</ul>
...
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> <s>회원 관리 페이지 레벨과 탈퇴 날짜 등 입력할 수 있는 페이지 필요</s></li>
...
<ul>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> <s>경기장 추가 구글 맵 연동</s></li>
