...
export const getGoalRankingFilter = async condition => {
  try {
    ...
    const response = await generalReq(
      "get",
      "/api/ranking/goalRankingFilter" + added_url
    );
    return response;
  } catch (e) {
    console.log(e);
...
export const getAssistRankingFilter = async condition => {
  try {
    ...
    const response = await generalReq(
      "get",
      "/api/ranking/assistRankingFilter" + added_url
    );
    return response;
  } catch (e) {
    console.log(e);
...
export const getCleanSheetRankingFilter = async condition => {
  try {
    ...
    const response = await generalReq(
      "get",
      "/api/ranking/cleanSheetRankingFilter" + added_url
    );
    return response;
  } catch (e) {
    console.log(e);
...
export const getLeagueRanking = async year => {
  try {
    const response = await generalReq(
      "get",
      "/api/ranking/leagueRanking/" + year
    );
...
export const getAttendRankingFilter = async condition => {
  try {
    ...
    const response = await generalReq(
      "get",
      "/api/ranking/attendRankingFilter" + added_url
    );
    return response;
  } catch (e) {
    console.log(e);
